...
Aby uruchomić program należy sklonować repozytorium lub pobrać plik zip i rozpakować go, następnie w terminalu, w folderze w którym znajduje się plik wpisać
```
python request.py
```
